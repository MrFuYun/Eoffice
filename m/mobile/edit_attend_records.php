...
$id = $_REQUEST['id'];
				...
				$sql = 'select user.user_name,attend_mobile_records.*
from attend_mobile_records 
join user
on attend_mobile_records.user_id=user.user_id
WHERE attend_mobile_records.record_id  = "'.$id.'"';
...
echo "<td><input type='text' value='{$row['wifi_mac']}' id='wifi_mac' name='wifi_mac'></td>";
echo "<td><input type='text' value='{$row['wifi_name']}' id='wifi_name' name='wifi_name'></td>";
echo "<td><input type='text' value='{$row['customer_id']}' id='customer_id' name='customer_id'></td>";
...
echo "<td><input type='text' value='{$row['sign_status']}' id='sign_status' name='sign_status'></td>";
echo "<td><input type='text' value='{$row['sign_category']}' id='sign_category' name='sign_category'></td>";
