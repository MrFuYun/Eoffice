...
$wifi_mac=$_REQUEST['wifi_mac'];
$wifi_name=$_REQUEST['wifi_name'];
$customer_id=$_REQUEST['customer_id'];
$platform=$_REQUEST['platform'];
$sign_type=$_REQUEST['sign_type'];
$sign_status=$_REQUEST['sign_status'];
$sign_category=$_REQUEST['sign_category'];
...
$sql='UPDATE attend_mobile_records SET sign_date= "'.$sign_date.'",	sign_time= "'.$sign_time.'",	ip= "'.$ip.'",	`long`= "'.$long.'",	lat= "'.$lat.'",	address= "'.$address.'",	wifi_mac= "'.$wifi_mac.'",	wifi_name= "'.$wifi_name.'",	customer_id= "'.$customer_id.'",	platform= "'.$platform.'",	sign_type= "'.$sign_type.'",	sign_status= "'.$sign_status.'",	sign_category= "'.$sign_category.'",	remark= "'.$remark.'",	created_at= "'.$created_at.'",	updated_at= "'.$updated_at.'"  WHERE record_id="'.$record_id.'"';
